...
export default function DepartureBoard() {
  ...
  return (
    <main className="min-h-dvh flex flex-col bg-[#000000] text-[#f4f4f7] selection:bg-white/10 relative overflow-hidden font-sans antialiased">
      ...
      <footer className="flex-shrink-0 border-t border-white/[0.04] bg-[#000000] py-5 px-4 pb-6 sm:pb-8">
        <div className="max-w-xl mx-auto flex flex-col gap-4 text-[#8e8e93] font-semibold tracking-wide uppercase">
          {/* Top Line: Brand Acknowledgement */}
          <div className="flex items-start gap-2.5 text-[10px] sm:text-[11px] leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-[9px] sm:text-[10px] border-t border-white/[0.03] pt-3.5">
            <div className="flex items-center gap-2">
